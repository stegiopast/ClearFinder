...
4. Add the orientation of the brain. The default settings match the orientation of the right hemisphere up. For more information about which orientation to choose visit -> https://christophkirst.github.io/ClearMap2Documentation/html/CellMap.html 
